...
const ThirdPage = () => {
  ...
  const buttonClick = async (e) => {
    try {
      const response = await axios.get(`http://192.168.1.95:9090/vehicle/calculate`, {
        params: {
          price,
          vyear
        }
  ...
  const sendEmail = async () => {
    ...
    try {
      const response = await axios.post(`http://192.168.1.95:9090/vehicle/sendEmail?toEmail=${toEmail}&vnumber=${vnumber}&price=${price}&idv=${idv}&premiumAmount=${premiumAmount}`);
    ...
    <div className='tp-main'>
      ...
      <div className='tp-sidenav '>
        ...
        <div className='row p-2 ms-3  '>
          ...
          <div className='ms-3 col-8 border rounded'>
            ...
            <div>
              <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" disabled={!premiumAmount}>Send Quotation</button>
