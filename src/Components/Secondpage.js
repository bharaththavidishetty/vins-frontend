  ...
  if (/^[6-9]\d{9}$/.test(formData.mobile)) {
    try {
      ...
      if (formData.mobile === response.data.mobile) {
        setMobileOtp1Error("Mobile number already exists");
      } else {
        try {
    ...
    if (/^[a-z0-9._%+-]+@gmail\.com$/.test(formData.email)) {
      try {
        ...
        if (formData.email===response.data.email) {
          setemailOtp1Error("Email is already existed")
        } else {
          try {
              ...
              <div className='d-flex flex-column col-lg-6 col-md-8 col-sm-10'>
                <form className='sp-form' onSubmit={handleSubmit}>
                  ...
                  <div className="sp-form-group ">
                    ...
                    />
                    <button type="button" className="sp-otp-button mt-2" onClick={handleSendMobileOTP}>Send OTP</button>
                  ...
                  <div className="sp-form-group">
                    ...
                    <input
                      ...
                      autoComplete='off'
                    />
                    <button type="button" className="sp-otp-button mt-2" onClick={handleSendEmailOTP}>Send OTP</button>
                  ...
                  <button type="submit" className="sp-submit-button px-5 py-2 rounded">Login</button>
                  </div>
                </form>
              </div>
