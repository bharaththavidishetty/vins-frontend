...
import p5 from '../images/propertyInsurance.png'
import PropertyInsuranceService from '../Components/service/PropertyInsuranceService'
import { Modal } from 'react-bootstrap'
import {GoogleLogin} from 'react-google-login';
import TextField from '@mui/material/TextField';
import { Tooltip, IconButton, InputAdornment } from '@mui/material';
import InfoIcon from '@mui/icons-material/Info';
import { regexMobileNo } from './RegularExpression';
...
import Ramanalogo from  '../images/ramanasoftlogo.jpg';
import CheckCircleOutlineIcon from '@mui/icons-material/CheckCircleOutline';
import AccountCircleSharpIcon from '@mui/icons-material/AccountCircleSharp';
import LoginSharpIcon from '@mui/icons-material/LoginSharp';
import img6 from '../images/vehiclein.png'
import img7 from '../images/bikeimage.jpg'
          ...
          <div className=' d-flex justify-content-evenly mt-lg-1 py-lg-0 py-2 lbdiv'>
            <div className='lbcard'>
              <Link to='/property'className=' text-decoration-none ' >
                <div class="card shadow bg-light" style={{width:'8rem' , height:`85%` ,zIndex:'-1'}}>
                  ...
                  <img src={p5} alt="..." className="img-fluid mx-1 mt-2 "/>
            ...
            <div class="card shadow bg-light" style={{width:'8rem', height:`85%`  , zIndex:'-1'}}>
              <div class="card-body">
                ...
                <img src={HealthIn} alt="..." className="img-fluid   w-100 mx-1  mt-4"/>
          ...
          <Link to='/1' className='text-decoration-none'>
            <div class="card shadow bg-light" style={{width:' 8rem', height:`85%`,zIndex:'-1'}}>
              <div class="card-body">
                ...
                <img src={img7} alt="..." className="img-fluid  w-100 mx-1 mt-4 "/>
